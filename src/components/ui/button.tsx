...
type ButtonSizeVariants = keyof typeof sizeClasses
...
function buttonVariants({ variant = "default", size = "default", className = "" }: Partial<ButtonProps>) {
    return cn(
...
function Button({
    ...
    // Determine the correct component (button or span) based on `asChild`
