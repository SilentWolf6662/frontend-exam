...
const Toast = (props: ToastProps) => {
    ...
    const toastType = toast.type as ToastTypes;
    ...
    offset.current = React.useMemo(() => heightIndex * gap + toastsHeightBefore, [heightIndex, toastsHeightBefore, gap]);
    ...
    React.useEffect(() => {
        ...
        if (toastNode) {
            ...
            setHeights((h) => [{ toastId: toast.id, height, position: toast.position as Position }, ...h]);
    ...
    React.useLayoutEffect(() => {
        if (!mounted) return;
        const toastNode = toastRef.current as HTMLLIElement;
            ...
            {possiblePositions.map((position, index) => {
                ...
                return (
                    <ol
                        ...
                        ref={listRef}
                        className={className}
                        data-toastwrapper-toaster
                        data-toastwrapper-theme={actualTheme}
                        data-y-position={y}
                        ...
                        {toasts
                            ...
                            .map((toast, index) => (
                                <Toast
                                    ...
                                    closeButton={toastOptions?.closeButton ?? closeButton as boolean}
